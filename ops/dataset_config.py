...
def return_somethingv2(modality):
    filename_categories = 'something/v2/category1.txt'
    if modality == 'RGB':
        root_data = ROOT_DATASET + 'something/v2/Gaze/Third-try(5fps)/p1'
        filename_imglist_train = 'something/v2/Gaze/Third-try(5fps)/group-label/4-cross/group-2/fold2_train.txt'
        filename_imglist_val = 'something/v2/Gaze/Third-try(5fps)/group-label/4-cross/group-2/test.txt'#cluster1_test.txt'
        prefix = '{:05d}.jpg'
    elif modality == 'Flow':
        '''
        ...
        '''
        '''
        root_data = ROOT_DATASET + 'something/v2/3.17hand/fangda'
        filename_imglist_train = 'something/v2/3.17hand/4c-train.txt'
        filename_imglist_val = 'something/v2/3.17hand/4c-val.txt'
        prefix = '{:06d}.jpg'
        '''
        root_data = ROOT_DATASET + 'something/v2/Gaze/5th-try(15fps)/p1'
        filename_imglist_train = 'something/v2/Gaze/5th-try(15fps)/group-label/4-cross/group-2/fold2_train.txt'
        filename_imglist_val = 'something/v2/Gaze/5th-try(15fps)/group-label/4-cross/group-2/test.txt'#cluster1_test.txt'
        prefix = '{:05d}.jpg'
